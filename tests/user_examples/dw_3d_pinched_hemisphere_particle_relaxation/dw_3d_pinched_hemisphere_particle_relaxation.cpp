...
public:
	...
	{
		add<TriangleMeshShapeSTL>(full_path_to_geometry, Vecd::Zero(), scale);
	}
};
//--------------------------------------------------------------------------
...
int main(int ac, char *av[])
{
	...
	relax_dynamics::ShellNormalDirectionPrediction shell_normal_prediction(imported_model_inner, thickness, cos(0.2 * Pi));
	//----------------------------------------------------------------------
