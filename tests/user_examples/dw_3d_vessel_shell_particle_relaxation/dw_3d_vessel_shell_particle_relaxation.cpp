...
//----------------------------------------------------------------------
std::string full_path_to_geometry = "./input/vessel_Vena_Cava.stl";
//----------------------------------------------------------------------
//	Basic geometry parameters and numerical setup.
//----------------------------------------------------------------------
//Vec3d domain_lower_bound(-9.0, -15.0, 97.0);
//Vec3d domain_upper_bound(47.0, 46.0, 418.0);
//Vec3d domain_lower_bound(-8.0, -15.0, 212.0);
//Vec3d domain_upper_bound(47.0, 21.0, 415.0);
//Vec3d domain_lower_bound(-77.0, 127.0, 59.0);
//Vec3d domain_upper_bound(81.0, 205.5, 453.0);
Vec3d domain_lower_bound(-52.0, 140.0, 198.0);
Vec3d domain_upper_bound(43.0, 184.0, 384.0);
Real dp_0 = 1.2;
Real thickness = 1.2;
...
int main(int ac, char *av[])
{
	...
	relax_dynamics::ShellNormalDirectionPrediction shell_normal_prediction(imported_model_inner, thickness, cos(0.1 * Pi));
	//----------------------------------------------------------------------
